 ...
 * }
 *
 * tb_for_if(tb_hash_item_t*, item, tb_iterator_head(iterator), tb_iterator_tail(iterator), iterator, item != tb_object_null)
 * {
 ...
 * }
 *
 * tb_for_all_if(tb_hash_item_t*, item, iterator, item != tb_object_null)
 * {
