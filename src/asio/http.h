...
/// open
#define tb_aicp_http_open(aicp_http, func, head, priv) 								tb_aicp_http_open_impl(aicp_http, func, head, priv __tb_debug_vals__)
...
/// open and read
#define tb_aicp_http_oread(aicp_http, maxn, func, head, priv) 						tb_aicp_http_oread_impl(aicp_http, maxn, func, head, priv __tb_debug_vals__)

/// open and writ
#define tb_aicp_http_owrit(aicp_http, data, size, head, func, priv) 				tb_aicp_http_owrit_impl(aicp_http, data, size, func, head, priv __tb_debug_vals__)

/// open and seek
#define tb_aicp_http_oseek(aicp_http, offset, func, head, priv) 					tb_aicp_http_oseek_impl(aicp_http, offset, func, head, priv __tb_debug_vals__)
 ...
 */
typedef tb_bool_t 			(*tb_aicp_http_head_func_t)(tb_handle_t http, tb_size_t state, tb_char_t const* line, tb_pointer_t priv);
 ...
 * @param http 		the http handle
 * @param func 		the func
 * @param head 		the head func
 * @param priv 		the func data
 *
 * @return 			tb_true or tb_false
 */
tb_bool_t 			tb_aicp_open_impl(tb_handle_t http, tb_aicp_http_open_func_t func, tb_aicp_http_head_func_t head, tb_pointer_t priv __tb_debug_decl__);
 ...
 * @return 			tb_true or tb_false
 */
tb_bool_t 			tb_aicp_http_oread_impl(tb_handle_t http, tb_size_t maxn, tb_aicp_http_read_func_t func, tb_aicp_http_head_func_t head, tb_pointer_t priv __tb_debug_decl__);
 ...
 * @return 			tb_true or tb_false
 */
tb_bool_t 			tb_aicp_http_owrit_impl(tb_handle_t http, tb_byte_t const* data, tb_size_t size, tb_aicp_http_writ_func_t func, tb_aicp_http_head_func_t head, tb_pointer_t priv __tb_debug_decl__);
 ...
 * @return 			tb_true or tb_false
 */
tb_bool_t 			tb_aicp_http_oseek_impl(tb_handle_t http, tb_hize_t offset, tb_aicp_http_seek_func_t func, tb_aicp_http_head_func_t head, tb_pointer_t priv __tb_debug_decl__);
