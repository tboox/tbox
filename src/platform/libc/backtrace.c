...
tb_size_t tb_backtrace_frames(tb_pointer_t* frames, tb_size_t nframe, tb_size_t nskip)
{
	...
	// trace
//	tb_trace("[backtrace]: __libc_stack_end: %p", __libc_stack_end);
	...
	// trace
//	tb_trace("[backtrace]: top_frame: %p", top_frame);
//	tb_trace("[backtrace]: top_stack: %p", top_stack);
	...
	{
		// trace
//		tb_trace("[backtrace]: current: %p", current);
