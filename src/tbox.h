 ...
 * @param data      the memory data for the memory pool, using the native memory if be tb_object_null
 ...
 * @code
    ...
    int main(int argc, char** argv)
    {
        ...
        if (!tb_init(tb_object_null, malloc(10 * 1024 * 1024), 10 * 1024 * 1024)) return 0;
#else
