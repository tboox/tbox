 ...
 * main
 */ 
tb_int_t tb_demo_stream_basic_stream_cache_main(tb_int_t argc, tb_char_t** argv)
{
	// init istream
...
//	tb_basic_stream_t* iostream = ostream;
	...
	// init fstream
	tb_basic_stream_t* fstream = tb_basic_stream_init_filter_from_cache(iostream, 0);
