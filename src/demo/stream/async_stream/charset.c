 ...
 * implementation
 */ 
static tb_bool_t tb_demo_async_stream_charset_save_func(tb_size_t state, tb_hize_t offset, tb_hong_t size, tb_hize_t save, tb_size_t rate, tb_pointer_t priv)
{
	// trace
...
//		tb_transfer_stream_limitrate(tstream, 4096);
		...
		if (!tb_transfer_stream_osave(tstream, tb_demo_async_stream_charset_save_func, aicp)) break;
