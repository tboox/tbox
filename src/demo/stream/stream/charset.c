 ...
 * main
 */ 
tb_int_t tb_demo_stream_stream_charset_main(tb_int_t argc, tb_char_t** argv)
{
    // init istream
...
//  tb_stream_t* iostream = ostream;
    ...
    // init fstream
    tb_stream_t* fstream = tb_stream_init_filter_from_charset(iostream, tb_charset_type(argv[3]), tb_charset_type(argv[4]));
