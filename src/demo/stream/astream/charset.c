 ...
 * implementation
 */ 
static tb_bool_t tb_demo_astream_charset_save_func(tb_handle_t tstream, tb_size_t state, tb_hize_t size, tb_size_t rate, tb_pointer_t priv)
{
	// trace
...
//		tb_tstream_limit(tstream, 4096);
		...
		if (!tb_tstream_osave(tstream, tb_demo_astream_charset_save_func, aicp)) break;
