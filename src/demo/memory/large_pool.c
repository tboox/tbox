...
tb_void_t tb_demo_large_pool_leak()
{
    ...
    do
    {
        ...
        // make data0
        tb_pointer_t data0 = tb_large_pool_malloc(pool, tb_page_size());
        tb_assert_and_check_break(data0);
    
        // make data1
        tb_pointer_t data1 = tb_large_pool_malloc(pool, tb_page_size());
...
tb_void_t tb_demo_large_pool_free2()
{
    ...
    do
    {
        ...
        // make data
        tb_pointer_t data = tb_large_pool_malloc(pool, tb_page_size());
...
tb_void_t tb_demo_large_pool_underflow2()
{
    ...
    do
    {
        ...
        // make data2
        data = tb_large_pool_malloc(pool, tb_page_size());
        tb_assert_and_check_break(data);
...
tb_void_t tb_demo_large_pool_perf()
{
    ...
    do
    {
        ...
        while (maxn--)
        {
            ...
            data = (__tb_volatile__ tb_byte_t*)tb_large_pool_malloc0(pool, size);
            if (!(maxn & 31)) 
            {
                size = tb_random_range(tb_random_generator(), 0, 16) * pagesize;
                data = (__tb_volatile__ tb_byte_t*)tb_large_pool_ralloc(pool, (tb_pointer_t)data, size);
            }
