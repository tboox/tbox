...
static tb_void_t tb_sort_int_test_perf(tb_size_t n)
{
    ...
    tb_sort_all(&iterator, tb_object_null);
    time = tb_mclock() - time;
...
static tb_void_t tb_sort_int_test_perf_bubble(tb_size_t n)
{
    ...
    // sort
    tb_hong_t time = tb_mclock();
    tb_bubble_sort_all(&iterator, tb_object_null);
    time = tb_mclock() - time;
...
static tb_void_t tb_sort_int_test_func_bubble()
{
    ...
    // sort
    tb_heap_sort_all(&iterator, tb_object_null);
...
static tb_void_t tb_sort_int_test_perf_insert(tb_size_t n)
{
    ...
    // sort
    tb_hong_t time = tb_mclock();
    tb_insert_sort_all(&iterator, tb_object_null);
    time = tb_mclock() - time;
...
static tb_void_t tb_sort_int_test_perf_quick(tb_size_t n)
{
    ...
    // sort
    tb_hong_t time = tb_mclock();
    tb_quick_sort_all(&iterator, tb_object_null);
    time = tb_mclock() - time;
