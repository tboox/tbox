...
{
    // set cookies
    tb_cookies_set(tb_cookies(), tb_object_null, tb_object_null, tb_false, "BAIDUID=0; max-age=946080000; expires=Sat, 06-Apr-41 03:21:53 GMT; domain=.baidu.com; path=/");
    tb_cookies_set(tb_cookies(), tb_object_null, tb_object_null, tb_true, "FG=1; max-age=946080000; expires=Sat, 06-Apr-2017 03:21:53 GMT; domain=.baidu.com; path=/; version=1");
    tb_cookies_set(tb_cookies(), tb_object_null, tb_object_null, tb_false, "BAIDUID=2; max-age=946080000; expires=Sat, 06-Apr-2016 03:21:53 GMT; domain=.baidu.com; path=/style; version=1");
    tb_cookies_set(tb_cookies(), tb_object_null, tb_object_null, tb_false, "BG=3; expires=Wednesday, 09-Nov-99 23:12:40 GMT; domain=.space.baidu.com; path=/");
    tb_cookies_set(tb_cookies(), tb_object_null, tb_object_null, tb_false, "BAIDSID=4; expires=Wednesday, 09-Nov-99 23:12:40 GMT; domain=.baidu.com; path=/style/foo");
    tb_cookies_set(tb_cookies(), tb_object_null, tb_object_null, tb_false, "pvid=3317093836; path=/; domain=qq.com; expires=Sun, 18 Jan 2038 00:00:00 GMT;");
    tb_cookies_set(tb_cookies(), tb_object_null, tb_object_null, tb_false, "clientuin=; EXPIRES=Fri, 02-Jan-1970 00:00:00 GMT; PATH=/; DOMAIN=qq.com;");
