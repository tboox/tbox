...
{
    // init
    tb_list_ref_t list = tb_list_init(TB_LIST_GROW_SIZE, tb_item_func_long());
...
{
    // init
    tb_list_ref_t list = tb_list_init(TB_LIST_GROW_SIZE, tb_item_func_size());
    tb_assert_and_check_return_val(list, 0);
...
{
    tb_list_ref_t list = tb_list_init(TB_LIST_GROW_SIZE, tb_item_func_str(tb_true, tb_null));
    tb_assert_and_check_return(list);
...
{
    tb_list_ref_t list = tb_list_init(TB_LIST_GROW_SIZE, tb_item_func_mem(11, tb_list_mem_free, "ifm"));
    tb_assert_and_check_return(list);
