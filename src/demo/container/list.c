...
{
    // init list
    tb_list_ref_t list = tb_list_init(0, tb_item_func_long());
...
{
    // init
    tb_list_ref_t list = tb_list_init(0, tb_item_func_size());
    tb_assert_and_check_return(list);
...
static tb_void_t tb_list_int_test()
{
    ...
    {
        // init list
        list = tb_list_init(0, tb_item_func_long());
...
static tb_void_t tb_list_str_test()
{
    ...
    {
        // init list
        list = tb_list_init(0, tb_item_func_str(tb_true));
        tb_assert_and_check_break(list);
...
static tb_void_t tb_list_mem_test()
{
    ...
    {
        // init list
        list = tb_list_init(0, tb_item_func_mem(11, tb_list_mem_free, "mem"));
        tb_assert_and_check_break(list);
...
static tb_void_t tb_list_walk_perf()
{
    ...
    while (n--) tb_list_insert_tail(list, (tb_pointer_t)(tb_size_t)tb_random_range(tb_null, 0, TB_MAXU32)); 
