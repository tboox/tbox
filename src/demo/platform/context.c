...
tb_int_t tb_demo_platform_context_main(tb_int_t argc, tb_char_t** argv)
{
    ...
    // make context1
    tb_context_make(g_context1, g_context0, g_context1_stack, sizeof(g_context1_stack), tb_demo_platform_context_func1, "context1");

    // make context2
    tb_context_make(g_context2, g_context1, g_context2_stack, sizeof(g_context2_stack), tb_demo_platform_context_func2, "context2");
