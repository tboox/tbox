...
int main(int argc, char** argv)
{
	...
	tb_cookies_set_from_url(cookies, "http://mail.evmtv.com:2000/WorldClient.dll?View=Main", "User=wangrq; Expires=Tue, 19-Apr-2012 07:10:56 GMT; path=/");
	tb_cookies_set_from_url(cookies, "http://mail.evmtv.com:2000/WorldClient.dll?View=Main", "Session=Yz9eJRh6QijR; path=/");
	tb_cookies_set_from_url(cookies, "http://mail.evmtv.com:2000/WorldClient.dll?View=Main", "Lang=zh; Expires=Tue, 19-Apr-2012 07:10:56 GMT; path=/");
