...
TB_DEMO_MAIN_DECL(stream_stream);
TB_DEMO_MAIN_DECL(stream_stream_zip);
TB_DEMO_MAIN_DECL(stream_stream_null);
TB_DEMO_MAIN_DECL(stream_stream_cache);
TB_DEMO_MAIN_DECL(stream_stream_charset);
