...
int main(int argc, char** argv)
{
	...
	tb_tstream_t* 		tst = tb_zstream_open_rlc(&zst, TB_ZSTREAM_ACTION_INFLATE);
#elif defined(TB_ZSTREAM_TEST_LZSW)
	tb_lzsw_zstream_t 	zst;
	tb_tstream_t* 		tst = tb_zstream_open_lzsw(&zst, TB_ZSTREAM_ACTION_INFLATE);
#endif
