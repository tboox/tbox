...
tb_char_t const* 	tb_stream_assign_format(tb_string_t* string, tb_char_t const* fmt, ...);
...
tb_char_t const* 	tb_stream_append_format(tb_string_t* string, tb_char_t const* fmt, ...);
