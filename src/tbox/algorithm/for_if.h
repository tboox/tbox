 ...
 * }
 *
 * tb_for_if(tb_hash_map_element_ref_t, item, tb_iterator_head(iterator), tb_iterator_tail(iterator), iterator, item != tb_null)
 * {
 ...
 * }
 *
 * tb_for_all_if(tb_hash_map_element_ref_t, item, iterator, item != tb_null)
 * {
