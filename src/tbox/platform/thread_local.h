...
/*! exit the thread local manually(optional) 
 *
 * @note the thread local will be exited and freed automaticlly after it's thread was returned or tb_exit() was called 
 *
