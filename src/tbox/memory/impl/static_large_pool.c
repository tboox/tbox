 ...
 */
static __tb_inline__ tb_size_t tb_static_large_pool_pred_index(tb_static_large_pool_impl_t* impl, tb_size_t space)
{
    // the size
...
static __tb_inline__ tb_void_t tb_static_large_pool_pred_update(tb_static_large_pool_impl_t* impl, tb_static_large_data_head_t* data_head)
{
    // check
    ...
    // the pred index
    tb_size_t indx = tb_static_large_pool_pred_index(impl, data_head->space);
...
static __tb_inline__ tb_void_t tb_static_large_pool_pred_remove(tb_static_large_pool_impl_t* impl, tb_static_large_data_head_t* data_head)
{
    // check
    ...
    while ((data_head + 1) <= data_tail && walk_size)
    {
        ...
        if (data_head->bfree)
        {
            ...
            if (data_space >= space)
            {
                ...
                tb_static_large_pool_pred_remove(impl, data_head);
                ...
                if (data_space > sizeof(tb_static_large_data_head_t) + space)
                {
                    ...
                    tb_static_large_pool_pred_update(impl, next_head);
                }
                else
                {
                    // the next data head
            ...
            else // attempt to merge next free data if this free data is too small
            {
                ...
                if (next_head->bfree)
                {
                    ...
                    tb_static_large_pool_pred_remove(impl, next_head);
                    ...
                    tb_static_large_pool_pred_update(impl, data_head);
...
static tb_static_large_data_head_t* tb_static_large_pool_malloc_pred(tb_static_large_pool_impl_t* impl, tb_size_t space)
{
    ...
    // walk the pred cache
    tb_size_t                       indx = tb_static_large_pool_pred_index(impl, space);
...
static tb_pointer_t tb_static_large_pool_malloc(tb_allocator_ref_t allocator, tb_size_t size, tb_size_t* real __tb_debug_decl__)
{
    // check
    tb_static_large_pool_impl_t* impl = (tb_static_large_pool_impl_t*)allocator;
...
static tb_pointer_t tb_static_large_pool_ralloc(tb_allocator_ref_t allocator, tb_pointer_t data, tb_size_t size, tb_size_t* real __tb_debug_decl__)
{
    // check
    tb_static_large_pool_impl_t* impl = (tb_static_large_pool_impl_t*)allocator;
...
static tb_bool_t tb_static_large_pool_free(tb_allocator_ref_t allocator, tb_pointer_t data __tb_debug_decl__)
{
    // check
    tb_static_large_pool_impl_t* impl = (tb_static_large_pool_impl_t*)allocator;
    tb_assert_and_check_return_val(impl && data, tb_false);
...
#ifdef __tb_debug__
static tb_void_t tb_static_large_pool_dump(tb_allocator_ref_t allocator)
{
    // check
    tb_static_large_pool_impl_t* impl = (tb_static_large_pool_impl_t*)allocator;
...
tb_large_pool_ref_t tb_static_large_pool_init(tb_byte_t* data, tb_size_t size, tb_size_t pagesize)
{
    ...
    impl->base.large_malloc     = tb_static_large_pool_malloc;
    impl->base.large_ralloc     = tb_static_large_pool_ralloc;
    impl->base.large_free       = tb_static_large_pool_free;
#ifdef __tb_debug__
    impl->base.dump             = tb_static_large_pool_dump;
#endif
    ...
    // add this free data to the pred cache
    tb_static_large_pool_pred_update(impl, impl->data_head);
