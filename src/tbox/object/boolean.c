 ...
 * implementation
 */
static __tb_inline__ tb_object_boolean_t* tb_object_boolean_cast(tb_object_refn_t object)
{
    // check
...
static tb_object_refn_t tb_object_boolean_copy(tb_object_refn_t object)
{
    // check
 ...
 * interfaces
 */
tb_object_refn_t tb_object_boolean_init(tb_bool_t value)
{
    return value? tb_object_boolean_true() : tb_object_boolean_false();
}
tb_object_refn_t tb_object_boolean_true()
{
    return (tb_object_refn_t)&g_boolean_true;
}
tb_object_refn_t tb_object_boolean_false()
{
    return (tb_object_refn_t)&g_boolean_false;
}
tb_bool_t tb_object_boolean_bool(tb_object_refn_t object)
{
