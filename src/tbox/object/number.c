 ...
 * implementation
 */
static __tb_inline__ tb_oc_number_t* tb_oc_number_cast(tb_oc_object_ref_t object)
{
    // check
...
static tb_oc_object_ref_t tb_oc_number_copy(tb_oc_object_ref_t object)
{
    // check
...
static tb_void_t tb_oc_number_exit(tb_oc_object_ref_t object)
{
    if (object) tb_free(object);
}
static tb_void_t tb_oc_number_clear(tb_oc_object_ref_t object)
{
    // check
    tb_oc_number_t* number = (tb_oc_number_t*)object;
...
static tb_oc_number_t* tb_oc_number_init_base()
{
    ...
    do
    {
        ...
        // init number
        if (!tb_oc_object_init((tb_oc_object_ref_t)number, TB_OBJECT_FLAG_NONE, TB_OBJECT_TYPE_NUMBER)) break;
    ...
    {
        // exit it
        if (number) tb_oc_object_exit((tb_oc_object_ref_t)number);
        number = tb_null;
    }
 ...
 * interfaces
 */
tb_oc_object_ref_t tb_oc_number_init_from_uint8(tb_uint8_t value)
{
    // make
    ...
    // ok
    return (tb_oc_object_ref_t)number;
}

tb_oc_object_ref_t tb_oc_number_init_from_sint8(tb_sint8_t value)
{
    // make
    tb_oc_number_t* number = tb_oc_number_init_base();
    tb_assert_and_check_return_val(number, tb_null);
...
tb_oc_object_ref_t tb_oc_number_init_from_uint16(tb_uint16_t value)
{
    // make
    tb_oc_number_t* number = tb_oc_number_init_base();
    tb_assert_and_check_return_val(number, tb_null);
...
tb_oc_object_ref_t tb_oc_number_init_from_sint16(tb_sint16_t value)
{
    // make
    tb_oc_number_t* number = tb_oc_number_init_base();
    tb_assert_and_check_return_val(number, tb_null);
...
tb_oc_object_ref_t tb_oc_number_init_from_uint32(tb_uint32_t value)
{
    // make
    tb_oc_number_t* number = tb_oc_number_init_base();
    tb_assert_and_check_return_val(number, tb_null);
...
tb_oc_object_ref_t tb_oc_number_init_from_sint32(tb_sint32_t value)
{
    // make
    tb_oc_number_t* number = tb_oc_number_init_base();
    tb_assert_and_check_return_val(number, tb_null);
...
tb_oc_object_ref_t tb_oc_number_init_from_uint64(tb_uint64_t value)
{
    // make
    tb_oc_number_t* number = tb_oc_number_init_base();
    tb_assert_and_check_return_val(number, tb_null);
...
tb_oc_object_ref_t tb_oc_number_init_from_sint64(tb_sint64_t value)
{
    // make
    tb_oc_number_t* number = tb_oc_number_init_base();
    tb_assert_and_check_return_val(number, tb_null);
...
#ifdef TB_CONFIG_TYPE_HAVE_FLOAT
tb_oc_object_ref_t tb_oc_number_init_from_float(tb_float_t value)
{
    // make
    tb_oc_number_t* number = tb_oc_number_init_base();
    tb_assert_and_check_return_val(number, tb_null);
...
tb_oc_object_ref_t tb_oc_number_init_from_double(tb_double_t value)
{
    // make
    tb_oc_number_t* number = tb_oc_number_init_base();
    tb_assert_and_check_return_val(number, tb_null);
...
tb_size_t tb_oc_number_type(tb_oc_object_ref_t object)
{
    // check
...
tb_uint8_t tb_oc_number_uint8(tb_oc_object_ref_t object)
{
    return (tb_uint8_t)tb_oc_number_uint64(object);
}
tb_sint8_t tb_oc_number_sint8(tb_oc_object_ref_t object)
{
    return (tb_sint8_t)tb_oc_number_sint64(object);
}
tb_uint16_t tb_oc_number_uint16(tb_oc_object_ref_t object)
{
    return (tb_uint16_t)tb_oc_number_uint64(object);
}
tb_sint16_t tb_oc_number_sint16(tb_oc_object_ref_t object)
{
    return (tb_sint16_t)tb_oc_number_sint64(object);
}
tb_uint32_t tb_oc_number_uint32(tb_oc_object_ref_t object)
{
    return (tb_uint32_t)tb_oc_number_uint64(object);
}
tb_sint32_t tb_oc_number_sint32(tb_oc_object_ref_t object)
{
    return (tb_sint32_t)tb_oc_number_sint64(object);
}
tb_uint64_t tb_oc_number_uint64(tb_oc_object_ref_t object)
{
    // check
    tb_oc_number_t* number = tb_oc_number_cast(object);
...
tb_sint64_t tb_oc_number_sint64(tb_oc_object_ref_t object)
{
    // check
    tb_oc_number_t* number = tb_oc_number_cast(object);
    tb_assert_and_check_return_val(number, 0);
...
#ifdef TB_CONFIG_TYPE_HAVE_FLOAT
tb_float_t tb_oc_number_float(tb_oc_object_ref_t object)
{
    // check
    tb_oc_number_t* number = tb_oc_number_cast(object);
    tb_assert_and_check_return_val(number, 0);
...
tb_double_t tb_oc_number_double(tb_oc_object_ref_t object)
{
    // check
    tb_oc_number_t* number = tb_oc_number_cast(object);
    tb_assert_and_check_return_val(number, 0);
...
#endif
tb_bool_t tb_oc_number_uint8_set(tb_oc_object_ref_t object, tb_uint8_t value)
{   
    // check
    tb_oc_number_t* number = tb_oc_number_cast(object);
...
tb_bool_t tb_oc_number_sint8_set(tb_oc_object_ref_t object, tb_sint8_t value)
{   
    // check
    tb_oc_number_t* number = tb_oc_number_cast(object);
    tb_assert_and_check_return_val(number, tb_false);
...
tb_bool_t tb_oc_number_uint16_set(tb_oc_object_ref_t object, tb_uint16_t value)
{   
    // check
    tb_oc_number_t* number = tb_oc_number_cast(object);
    tb_assert_and_check_return_val(number, tb_false);
...
tb_bool_t tb_oc_number_sint16_set(tb_oc_object_ref_t object, tb_sint16_t value)
{   
    // check
    tb_oc_number_t* number = tb_oc_number_cast(object);
    tb_assert_and_check_return_val(number, tb_false);
...
tb_bool_t tb_oc_number_uint32_set(tb_oc_object_ref_t object, tb_uint32_t value)
{   
    // check
    tb_oc_number_t* number = tb_oc_number_cast(object);
    tb_assert_and_check_return_val(number, tb_false);
...
tb_bool_t tb_oc_number_sint32_set(tb_oc_object_ref_t object, tb_sint32_t value)
{   
    // check
    tb_oc_number_t* number = tb_oc_number_cast(object);
    tb_assert_and_check_return_val(number, tb_false);
...
tb_bool_t tb_oc_number_uint64_set(tb_oc_object_ref_t object, tb_uint64_t value)
{   
    // check
    tb_oc_number_t* number = tb_oc_number_cast(object);
    tb_assert_and_check_return_val(number, tb_false);
...
tb_bool_t tb_oc_number_sint64_set(tb_oc_object_ref_t object, tb_sint64_t value)
{   
    // check
    tb_oc_number_t* number = tb_oc_number_cast(object);
    tb_assert_and_check_return_val(number, tb_false);
...
#ifdef TB_CONFIG_TYPE_HAVE_FLOAT
tb_bool_t tb_oc_number_float_set(tb_oc_object_ref_t object, tb_float_t value)
{   
    // check
    tb_oc_number_t* number = tb_oc_number_cast(object);
    tb_assert_and_check_return_val(number, tb_false);
...
tb_bool_t tb_oc_number_double_set(tb_oc_object_ref_t object, tb_double_t value)
{   
    // check
    tb_oc_number_t* number = tb_oc_number_cast(object);
    tb_assert_and_check_return_val(number, tb_false);
