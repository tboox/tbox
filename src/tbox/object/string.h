 ...
 * @return          the c-string
 */
tb_char_t const*    tb_oc_string_cstr(tb_oc_object_ref_t string);
 ...
 */
tb_size_t           tb_oc_string_cstr_set(tb_oc_object_ref_t string, tb_char_t const* cstr);
 ...
 * @return          the string size
 */
tb_size_t           tb_oc_string_size(tb_oc_object_ref_t string);
