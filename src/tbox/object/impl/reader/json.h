...
typedef struct __tb_oc_object_json_reader_t
{
    /// the stream
    tb_stream_ref_t              stream;

}tb_oc_object_json_reader_t;

/// the json reader func type
typedef tb_oc_object_ref_t            (*tb_oc_object_json_reader_func_t)(tb_oc_object_json_reader_t* reader, tb_char_t type);
 ...
 */
tb_oc_object_reader_t*             tb_oc_object_json_reader(tb_noarg_t);
