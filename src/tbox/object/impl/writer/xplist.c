 ...
 * implementation
 */
static tb_bool_t tb_object_xplist_writer_func_date(tb_object_xplist_writer_t* writer, tb_object_refn_t object, tb_size_t level)
{
    // check
...
static tb_bool_t tb_object_xplist_writer_func_data(tb_object_xplist_writer_t* writer, tb_object_refn_t object, tb_size_t level)
{
    // check
    tb_assert_and_check_return_val(writer && writer->stream, tb_false);
...
static tb_bool_t tb_object_xplist_writer_func_array(tb_object_xplist_writer_t* writer, tb_object_refn_t object, tb_size_t level)
{
    // check
    tb_assert_and_check_return_val(writer && writer->stream, tb_false);
...
static tb_bool_t tb_object_xplist_writer_func_string(tb_object_xplist_writer_t* writer, tb_object_refn_t object, tb_size_t level)
{
    // check
    tb_assert_and_check_return_val(writer && writer->stream, tb_false);
...
static tb_bool_t tb_object_xplist_writer_func_number(tb_object_xplist_writer_t* writer, tb_object_refn_t object, tb_size_t level)
{
    // check
    tb_assert_and_check_return_val(writer && writer->stream, tb_false);
...
static tb_bool_t tb_object_xplist_writer_func_boolean(tb_object_xplist_writer_t* writer, tb_object_refn_t object, tb_size_t level)
{
    // check
    tb_assert_and_check_return_val(writer && writer->stream, tb_false);
...
static tb_bool_t tb_object_xplist_writer_func_dictionary(tb_object_xplist_writer_t* writer, tb_object_refn_t object, tb_size_t level)
{
    // check
    tb_assert_and_check_return_val(writer && writer->stream, tb_false);
...
static tb_long_t tb_object_xplist_writer_done(tb_stream_ref_t stream, tb_object_refn_t object, tb_bool_t deflate)
{
    // check
...
tb_object_writer_t* tb_object_xplist_writer()
{
    ...
    // hook writer 
    tb_hash_map_insert(s_writer.hooker, (tb_pointer_t)TB_OBJECT_TYPE_DATE, tb_object_xplist_writer_func_date);
    tb_hash_map_insert(s_writer.hooker, (tb_pointer_t)TB_OBJECT_TYPE_DATA, tb_object_xplist_writer_func_data);
    tb_hash_map_insert(s_writer.hooker, (tb_pointer_t)TB_OBJECT_TYPE_ARRAY, tb_object_xplist_writer_func_array);
    tb_hash_map_insert(s_writer.hooker, (tb_pointer_t)TB_OBJECT_TYPE_STRING, tb_object_xplist_writer_func_string);
    tb_hash_map_insert(s_writer.hooker, (tb_pointer_t)TB_OBJECT_TYPE_NUMBER, tb_object_xplist_writer_func_number);
    tb_hash_map_insert(s_writer.hooker, (tb_pointer_t)TB_OBJECT_TYPE_BOOLEAN, tb_object_xplist_writer_func_boolean);
    tb_hash_map_insert(s_writer.hooker, (tb_pointer_t)TB_OBJECT_TYPE_DICTIONARY, tb_object_xplist_writer_func_dictionary);
...
tb_object_xplist_writer_func_t tb_object_xplist_writer_func(tb_size_t type)
{
    ...
    // the func
    return (tb_object_xplist_writer_func_t)tb_hash_map_get(writer->hooker, (tb_pointer_t)type);
}
