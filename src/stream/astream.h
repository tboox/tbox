...
,	TB_ASTREAM_CTRL_HTTP_GET_AUTO_UNZIP		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 8)
,	TB_ASTREAM_CTRL_HTTP_GET_POST_URL		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 9)
,	TB_ASTREAM_CTRL_HTTP_GET_POST_DATA		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 10)
,	TB_ASTREAM_CTRL_HTTP_GET_POST_FUNC		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 11)
,	TB_ASTREAM_CTRL_HTTP_GET_POST_PRIV		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 12)
,	TB_ASTREAM_CTRL_HTTP_GET_POST_LRATE		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 13)

,	TB_ASTREAM_CTRL_HTTP_SET_HEAD 			= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 20)
,	TB_ASTREAM_CTRL_HTTP_SET_RANGE 			= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 21)
,	TB_ASTREAM_CTRL_HTTP_SET_METHOD 		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 22)
,	TB_ASTREAM_CTRL_HTTP_SET_VERSION		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 23)
,	TB_ASTREAM_CTRL_HTTP_SET_REDIRECT		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 24)
,	TB_ASTREAM_CTRL_HTTP_SET_HEAD_FUNC		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 25)
,	TB_ASTREAM_CTRL_HTTP_SET_HEAD_PRIV		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 26)
,	TB_ASTREAM_CTRL_HTTP_SET_AUTO_UNZIP		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 27)
,	TB_ASTREAM_CTRL_HTTP_SET_POST_URL		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 28)
,	TB_ASTREAM_CTRL_HTTP_SET_POST_DATA		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 29)
,	TB_ASTREAM_CTRL_HTTP_SET_POST_FUNC		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 30)
,	TB_ASTREAM_CTRL_HTTP_SET_POST_PRIV		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 31)
,	TB_ASTREAM_CTRL_HTTP_SET_POST_LRATE		= TB_ASTREAM_CTRL(TB_ASTREAM_TYPE_HTTP, 32)
...
,	TB_ASTREAM_STATE_PAUSED 				= 3
,	TB_ASTREAM_STATE_NOT_SUPPORTED 			= 4
,	TB_ASTREAM_STATE_UNKNOWN_ERROR 			= 5
