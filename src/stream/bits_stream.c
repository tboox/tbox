...
{
	return tb_bits_stream_get_string(bst);
}
...
tb_uint32_t tb_bits_stream_peek_ubits32(tb_bits_stream_t* bst, tb_size_t nbits)
{
	...
	// peek value
	tb_uint32_t val = tb_bits_stream_get_ubits32(bst, nbits);
...
tb_sint32_t tb_bits_stream_peek_sbits32(tb_bits_stream_t* bst, tb_size_t nbits)
{
	...
	// peek value
	tb_sint32_t val = tb_bits_stream_get_sbits32(bst, nbits);
