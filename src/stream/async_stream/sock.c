...
static tb_void_t tb_async_stream_sock_dns_func(tb_handle_t haddr, tb_char_t const* host, tb_ipv4_t const* addr, tb_pointer_t data)
{
	// check
	tb_async_stream_sock_t* sstream = tb_async_stream_sock_cast(data);
