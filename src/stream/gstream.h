...
,	TB_GSTREAM_CTRL_SET_TIMEOUT 		= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_NONE, 18)
	...
	// the dstream
,	TB_DSTREAM_CTRL_SET_DATA 			= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_DATA, 1)

	// the fstream
,	TB_FSTREAM_CTRL_SET_MODE 			= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_FILE, 1)
,	TB_FSTREAM_CTRL_SET_HANDLE 			= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_FILE, 2)
,	TB_FSTREAM_CTRL_GET_HANDLE 			= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_FILE, 3)

	// the sstream
,	TB_SSTREAM_CTRL_SET_TYPE 			= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_SOCK, 1)
,	TB_SSTREAM_CTRL_SET_HANDLE 			= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_SOCK, 2)
,	TB_SSTREAM_CTRL_GET_HANDLE 			= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_SOCK, 3)

	// the hstream
,	TB_HSTREAM_CTRL_GET_OPTION 			= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 1)
,	TB_HSTREAM_CTRL_GET_STATUS 			= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 2)

	// the tstream
,	TB_TSTREAM_CTRL_GET_GSTREAM 		= TB_TSTREAM_CTRL(TB_TSTREAM_TYPE_NONE, 1)
,	TB_TSTREAM_CTRL_SET_GSTREAM 		= TB_TSTREAM_CTRL(TB_TSTREAM_TYPE_NONE, 2)

	// the cstream
,	TB_CSTREAM_CTRL_GET_FTYPE 			= TB_TSTREAM_CTRL(TB_TSTREAM_TYPE_CHARSET, 1)
,	TB_CSTREAM_CTRL_GET_TTYPE 			= TB_TSTREAM_CTRL(TB_TSTREAM_TYPE_CHARSET, 2)

,	TB_CSTREAM_CTRL_SET_FTYPE 			= TB_TSTREAM_CTRL(TB_TSTREAM_TYPE_CHARSET, 3)
,	TB_CSTREAM_CTRL_SET_TTYPE 			= TB_TSTREAM_CTRL(TB_TSTREAM_TYPE_CHARSET, 4)

	// the zstream
,	TB_ZSTREAM_CTRL_GET_ALGO			= TB_TSTREAM_CTRL(TB_TSTREAM_TYPE_ZIP, 1)
,	TB_ZSTREAM_CTRL_GET_ACTION			= TB_TSTREAM_CTRL(TB_TSTREAM_TYPE_ZIP, 2)
,	TB_ZSTREAM_CTRL_SET_ALGO			= TB_TSTREAM_CTRL(TB_TSTREAM_TYPE_ZIP, 3)
,	TB_ZSTREAM_CTRL_SET_ACTION			= TB_TSTREAM_CTRL(TB_TSTREAM_TYPE_ZIP, 4)
...
,	TB_SSTREAM_STATE_DNS_FAILED 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_SOCK, 1)
,	TB_SSTREAM_STATE_CONNECT_FAILED		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_SOCK, 2)
,	TB_SSTREAM_STATE_SSL_FAILED			= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_SOCK, 3)

,	TB_HSTREAM_STATE_RESPONSE_204 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 1)
,	TB_HSTREAM_STATE_RESPONSE_300 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 2)
,	TB_HSTREAM_STATE_RESPONSE_301 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 3)
,	TB_HSTREAM_STATE_RESPONSE_302 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 4)
,	TB_HSTREAM_STATE_RESPONSE_303 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 5)
,	TB_HSTREAM_STATE_RESPONSE_304 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 6)
,	TB_HSTREAM_STATE_RESPONSE_400 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 7)
,	TB_HSTREAM_STATE_RESPONSE_401 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 8)
,	TB_HSTREAM_STATE_RESPONSE_402 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 9)
,	TB_HSTREAM_STATE_RESPONSE_403 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 10)
,	TB_HSTREAM_STATE_RESPONSE_404 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 11)
,	TB_HSTREAM_STATE_RESPONSE_405 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 12)
,	TB_HSTREAM_STATE_RESPONSE_406 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 13)
,	TB_HSTREAM_STATE_RESPONSE_407 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 14)
,	TB_HSTREAM_STATE_RESPONSE_408 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 15)
,	TB_HSTREAM_STATE_RESPONSE_409 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 16)
,	TB_HSTREAM_STATE_RESPONSE_410 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 17)
,	TB_HSTREAM_STATE_RESPONSE_411 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 18)
,	TB_HSTREAM_STATE_RESPONSE_412 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 19)
,	TB_HSTREAM_STATE_RESPONSE_413 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 20)
,	TB_HSTREAM_STATE_RESPONSE_414 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 21)
,	TB_HSTREAM_STATE_RESPONSE_415 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 22)
,	TB_HSTREAM_STATE_RESPONSE_416 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 23)
,	TB_HSTREAM_STATE_RESPONSE_500 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 24)
,	TB_HSTREAM_STATE_RESPONSE_501 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 25)
,	TB_HSTREAM_STATE_RESPONSE_502 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 26)
,	TB_HSTREAM_STATE_RESPONSE_503 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 27)
,	TB_HSTREAM_STATE_RESPONSE_504 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 28)
,	TB_HSTREAM_STATE_RESPONSE_505 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 29)
,	TB_HSTREAM_STATE_RESPONSE_506 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 30)
,	TB_HSTREAM_STATE_RESPONSE_507 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 31)
,	TB_HSTREAM_STATE_RESPONSE_UNK 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 32)
,	TB_HSTREAM_STATE_RESPONSE_NUL 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 33)
,	TB_HSTREAM_STATE_REQUEST_FAILED 	= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 34)
,	TB_HSTREAM_STATE_UNKNOWN_ERROR 		= TB_GSTREAM_STATE(TB_GSTREAM_TYPE_HTTP, 35)
