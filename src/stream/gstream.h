...
,	TB_GSTREAM_CTRL_GET_SIZE 				= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_NONE, 9)
,	TB_GSTREAM_CTRL_IS_OPENED 				= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_NONE, 10)

,	TB_GSTREAM_CTRL_SET_URL 				= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_NONE, 12)
,	TB_GSTREAM_CTRL_SET_HOST 				= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_NONE, 13)
,	TB_GSTREAM_CTRL_SET_PORT 				= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_NONE, 14)
,	TB_GSTREAM_CTRL_SET_PATH 				= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_NONE, 15)
,	TB_GSTREAM_CTRL_SET_SSL 				= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_NONE, 16)
...
,	TB_GSTREAM_CTRL_HTTP_GET_RANGE 			= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 2)
,	TB_GSTREAM_CTRL_HTTP_GET_METHOD 		= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 3)
,	TB_GSTREAM_CTRL_HTTP_GET_VERSION		= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 4)
,	TB_GSTREAM_CTRL_HTTP_GET_REDIRECT		= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 5) 
,	TB_GSTREAM_CTRL_HTTP_GET_HEAD_FUNC		= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 6)
,	TB_GSTREAM_CTRL_HTTP_GET_HEAD_PRIV		= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 7)
,	TB_GSTREAM_CTRL_HTTP_GET_POST_SIZE 		= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 8)
,	TB_GSTREAM_CTRL_HTTP_GET_AUTO_UNZIP		= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 9)

,	TB_GSTREAM_CTRL_HTTP_SET_HEAD 			= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 10)
,	TB_GSTREAM_CTRL_HTTP_SET_RANGE 			= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 11)
,	TB_GSTREAM_CTRL_HTTP_SET_METHOD 		= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 12)
,	TB_GSTREAM_CTRL_HTTP_SET_VERSION		= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 13)
,	TB_GSTREAM_CTRL_HTTP_SET_REDIRECT		= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 14)
,	TB_GSTREAM_CTRL_HTTP_SET_HEAD_FUNC		= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 15)
,	TB_GSTREAM_CTRL_HTTP_SET_HEAD_PRIV		= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 16)
,	TB_GSTREAM_CTRL_HTTP_SET_POST_SIZE 		= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 17)
,	TB_GSTREAM_CTRL_HTTP_SET_AUTO_UNZIP		= TB_GSTREAM_CTRL(TB_GSTREAM_TYPE_HTTP, 18)
