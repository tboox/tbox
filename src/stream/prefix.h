...
,	TB_STREAM_CTRL_GET_CACHE 				= TB_STREAM_CTRL(TB_STREAM_TYPE_NONE, 9)
,	TB_STREAM_CTRL_IS_OPENED 				= TB_STREAM_CTRL(TB_STREAM_TYPE_NONE, 10)
...
,	TB_STREAM_CTRL_SET_CACHE 				= TB_STREAM_CTRL(TB_STREAM_TYPE_NONE, 16)
