...
,	TB_STREAM_CTRL_GET_CACHE 				= TB_STREAM_CTRL(TB_STREAM_TYPE_NONE, 9) 	//!< TODO: discard
,	TB_STREAM_CTRL_IS_OPENED 				= TB_STREAM_CTRL(TB_STREAM_TYPE_NONE, 10) 	//!< TODO: discard
...
,	TB_STREAM_CTRL_SET_CACHE 				= TB_STREAM_CTRL(TB_STREAM_TYPE_NONE, 16) 	//!< TODO: discard
,	TB_STREAM_CTRL_SET_TIMEOUT 				= TB_STREAM_CTRL(TB_STREAM_TYPE_NONE, 17)
...
,	TB_STREAM_CTRL_HTTP_GET_POST_SIZE		= TB_STREAM_CTRL(TB_STREAM_TYPE_HTTP, 24) 	//!< TODO: discard
...
,	TB_STREAM_CTRL_HTTP_SET_POST_SIZE		= TB_STREAM_CTRL(TB_STREAM_TYPE_HTTP, 33) 	//!< TODO: discard
