...
,	TB_STREAM_CTRL_GET_CACHE 				= TB_STREAM_CTRL(TB_STREAM_TYPE_NONE, 7)
,	TB_STREAM_CTRL_GET_SIZE 				= TB_STREAM_CTRL(TB_STREAM_TYPE_NONE, 8)
,	TB_STREAM_CTRL_GET_OFFSET 				= TB_STREAM_CTRL(TB_STREAM_TYPE_NONE, 9)
...
,	TB_STREAM_CTRL_SET_CACHE 				= TB_STREAM_CTRL(TB_STREAM_TYPE_NONE, 17)
...
,	TB_STREAM_SOCK_STATE_SEND_FAILED		= TB_STREAM_STATE(TB_STREAM_TYPE_SOCK, 7)
