...
,	TB_STREAM_SOCK_STATE_RECV_TIMEOUT		= TB_STREAM_STATE(TB_STREAM_TYPE_SOCK, 4)
,	TB_STREAM_SOCK_STATE_SEND_TIMEOUT		= TB_STREAM_STATE(TB_STREAM_TYPE_SOCK, 5)
,	TB_STREAM_SOCK_STATE_SEND_FAILED		= TB_STREAM_STATE(TB_STREAM_TYPE_SOCK, 6)
,	TB_STREAM_SOCK_STATE_SSL_FAILED			= TB_STREAM_STATE(TB_STREAM_TYPE_SOCK, 7)
,	TB_STREAM_SOCK_STATE_SSL_TIMEOUT		= TB_STREAM_STATE(TB_STREAM_TYPE_SOCK, 8)
,	TB_STREAM_SOCK_STATE_SSL_WANT_READ		= TB_STREAM_STATE(TB_STREAM_TYPE_SOCK, 9)
,	TB_STREAM_SOCK_STATE_SSL_WANT_WRIT		= TB_STREAM_STATE(TB_STREAM_TYPE_SOCK, 10)
,	TB_STREAM_SOCK_STATE_SSL_WAIT_FAILED	= TB_STREAM_STATE(TB_STREAM_TYPE_SOCK, 11)
...
,	TB_STREAM_HTTP_STATE_REDIRECT_FAILED 	= TB_STREAM_STATE(TB_STREAM_TYPE_HTTP, 35)
,	TB_STREAM_HTTP_STATE_POST_FAILED 		= TB_STREAM_STATE(TB_STREAM_TYPE_HTTP, 36)
,	TB_STREAM_HTTP_STATE_RANGE_INVALID 		= TB_STREAM_STATE(TB_STREAM_TYPE_HTTP, 37)
