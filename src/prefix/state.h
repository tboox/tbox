...
,	TB_STATE_KILLED 					= TB_STATE_DEFINE(TB_STATE_TYPE_NONE, 1)
,	TB_STATE_PAUSED 					= TB_STATE_DEFINE(TB_STATE_TYPE_NONE, 2)
,	TB_STATE_CLOSED 					= TB_STATE_DEFINE(TB_STATE_TYPE_NONE, 3)
,	TB_STATE_PENDING 					= TB_STATE_DEFINE(TB_STATE_TYPE_NONE, 4)
,	TB_STATE_TIMEOUT 					= TB_STATE_DEFINE(TB_STATE_TYPE_NONE, 5)
,	TB_STATE_WAIT_FAILED 				= TB_STATE_DEFINE(TB_STATE_TYPE_NONE, 6)
,	TB_STATE_NOT_SUPPORTED 				= TB_STATE_DEFINE(TB_STATE_TYPE_NONE, 7)
,	TB_STATE_UNKNOWN_ERROR 				= TB_STATE_DEFINE(TB_STATE_TYPE_NONE, 8)
...
,	TB_STATE_SOCK_SEND_FAILED			= TB_STATE_DEFINE(TB_STATE_TYPE_SOCK, 6)
,	TB_STATE_SOCK_SSL_FAILED			= TB_STATE_DEFINE(TB_STATE_TYPE_SOCK, 7)
,	TB_STATE_SOCK_SSL_TIMEOUT			= TB_STATE_DEFINE(TB_STATE_TYPE_SOCK, 8)
,	TB_STATE_SOCK_SSL_WANT_READ			= TB_STATE_DEFINE(TB_STATE_TYPE_SOCK, 9)
,	TB_STATE_SOCK_SSL_WANT_WRIT			= TB_STATE_DEFINE(TB_STATE_TYPE_SOCK, 10)
,	TB_STATE_SOCK_SSL_WAIT_FAILED		= TB_STATE_DEFINE(TB_STATE_TYPE_SOCK, 11)
