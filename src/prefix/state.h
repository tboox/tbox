...
,	TB_STATE_KILLING 					= TB_STATE_DEFINE(TB_STATE_TYPE_NONE, 9)
,	TB_STATE_PAUSING 					= TB_STATE_DEFINE(TB_STATE_TYPE_NONE, 10)
,	TB_STATE_EXITING 					= TB_STATE_DEFINE(TB_STATE_TYPE_NONE, 11)
,	TB_STATE_TIMEOUT 					= TB_STATE_DEFINE(TB_STATE_TYPE_NONE, 12)
,	TB_STATE_WAIT_FAILED 				= TB_STATE_DEFINE(TB_STATE_TYPE_NONE, 13)
,	TB_STATE_NOT_SUPPORTED 				= TB_STATE_DEFINE(TB_STATE_TYPE_NONE, 14)
,	TB_STATE_UNKNOWN_ERROR 				= TB_STATE_DEFINE(TB_STATE_TYPE_NONE, 15)
...
,	TB_STATE_HTTP_UNKNOWN_ERROR			= TB_STATE_DEFINE(TB_STATE_TYPE_HTTP, 39)
