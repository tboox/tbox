...
static tb_bool_t tb_object_bin_writer_func_date(tb_object_bin_writer_t* writer, tb_object_t* object)
{
	...
	// writ type & time
	return tb_object_writer_bin_type_size(writer->stream, object->type, (tb_uint64_t)tb_date_time(object));
}
...
static tb_bool_t tb_object_bin_writer_func_number(tb_object_bin_writer_t* writer, tb_object_t* object)
{
	...
	// writ type
	if (!tb_object_writer_bin_type_size(writer->stream, object->type, (tb_uint64_t)tb_number_type(object))) return tb_false;
...
static tb_bool_t tb_object_bin_writer_func_boolean(tb_object_bin_writer_t* writer, tb_object_t* object)
{
	...
	// writ type & bool
	return tb_object_writer_bin_type_size(writer->stream, object->type, tb_boolean_bool(object));
}
...
static tb_long_t tb_object_bin_writer_done(tb_gstream_t* stream, tb_object_t* object, tb_bool_t deflate)
{
	// check
	...
	do
	{
		...
		// sync
		if (!tb_gstream_sync(stream, tb_true)) break;
