...
// the item func
typedef tb_void_t 	(*tb_dlist_item_free_func_t)(tb_void_t* item, tb_void_t* priv);	

// the dlist item func type
typedef struct __tb_dlist_item_func_t
{
	// the item func
	tb_dlist_item_free_func_t 	free;

	// the priv data
	tb_void_t* 					priv;

}tb_dlist_item_func_t;
