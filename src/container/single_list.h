 ...
 *
 * @code
 * tb_bool_t tb_single_list_item_func(tb_single_list_ref_t list, tb_pointer_t item, tb_bool_t* bdel, tb_cpointer_t priv)
 * {
 ...
 *
 */
tb_void_t               tb_single_list_walk(tb_single_list_ref_t list, tb_bool_t (*func)(tb_single_list_ref_t list, tb_pointer_t item, tb_bool_t* bdel, tb_cpointer_t priv), tb_cpointer_t priv);
