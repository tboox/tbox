 ...
 *
 * @code
 * tb_bool_t tb_list_item_func(tb_list_t* list, tb_pointer_t item, tb_bool_t* bdel, tb_pointer_t priv)
 * {
 * 		// check
 ...
 *
 */
tb_void_t 			tb_list_walk(tb_list_t* list, tb_bool_t (*func)(tb_list_t* list, tb_pointer_t item, tb_bool_t* bdel, tb_pointer_t priv), tb_pointer_t priv);
