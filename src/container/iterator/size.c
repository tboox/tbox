 ...
 * implementation
 */
static tb_pointer_t tb_iterator_init_size_item(tb_iterator_t* iterator, tb_size_t itor)
{
    // check
...
static tb_void_t tb_iterator_init_size_copy(tb_iterator_t* iterator, tb_size_t itor, tb_cpointer_t item)
{
    // check
...
static tb_long_t tb_iterator_init_size_comp(tb_iterator_t* iterator, tb_cpointer_t ltem, tb_cpointer_t rtem)
{
