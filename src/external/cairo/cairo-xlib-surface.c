...
found:
    ...
    surface = tb_malloc (sizeof (cairo_xlib_surface_t));
			       ...
			       cairo_scaled_font_t  *scaled_font)
{
    ...
    font_private = tb_malloc (sizeof (cairo_xlib_surface_font_private_t));
				       ...
				       cairo_scaled_font_t  *scaled_font)
{
	...
	if (to_free == NULL) {
	    to_free = tb_malloc (sizeof (cairo_xlib_font_glyphset_free_glyphs_t));
