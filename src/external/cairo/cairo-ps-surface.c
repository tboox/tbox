...
_cairo_ps_surface_get_page_media (cairo_ps_surface_t     *surface)
{
    ...
    page = tb_malloc (sizeof (cairo_page_media_t));
					      ...
					      double		     height)
{
    ...
    surface = tb_malloc (sizeof (cairo_ps_surface_t));
...
_string_array_stream_create (cairo_output_stream_t *output)
{
    ...
    stream = tb_malloc (sizeof (string_array_stream_t));
