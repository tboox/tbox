 ...
 * element and should tb_free any memory and resources allocated for it.
 **/
 ...
 * @glyphs points at has changed after the call, the caller will tb_free the
 ...
 * will tb_free the allocated cluster array using cairo_text_cluster_free().
 *
...
typedef enum _cairo_format 
{
	...
	CAIRO_FORMAT_ARGB8888 	= 2,
	CAIRO_FORMAT_RGB888 	= 3,
	CAIRO_FORMAT_RGB565 	= 4,
	CAIRO_FORMAT_ARGB1555 	= 5,
	CAIRO_FORMAT_ARGB4444 	= 6,

	CAIRO_FORMAT_A8 		= 7,
	CAIRO_FORMAT_A1 		= 8,
	CAIRO_FORMAT_RGB16_565 	= 9
