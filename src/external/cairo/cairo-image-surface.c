...
_cairo_format_from_pixman_format (pixman_format_code_t pixman_format)
{
    ...
    case PIXMAN_a8r8g8b8:
		return CAIRO_FORMAT_ARGB8888;
	case PIXMAN_r8g8b8:
		return CAIRO_FORMAT_RGB888;
	case PIXMAN_r5g6b5:
		return CAIRO_FORMAT_RGB565;
	case PIXMAN_x1r5g5b5:
		return CAIRO_FORMAT_ARGB1555;
    /*case PIXMAN_a8r8g8b8:
					      ...
					      pixman_format_code_t	 pixman_format)
{
    ...
    surface = tb_malloc (sizeof (cairo_image_surface_t));
...
_cairo_format_to_pixman_format_code (cairo_format_t format)
{
    ...
    case CAIRO_FORMAT_A8:
		ret = PIXMAN_a8;
		break;
	case CAIRO_FORMAT_ARGB8888:
		ret = PIXMAN_a8r8g8b8;
		break;
	case CAIRO_FORMAT_RGB888:
		ret = PIXMAN_r8g8b8;
		break;
	case CAIRO_FORMAT_RGB565:
		ret = PIXMAN_r5g6b5;
		break;
	case CAIRO_FORMAT_ARGB1555:
		ret = PIXMAN_x1r5g5b5;
		break;
 ...
 *     kind of variable, (for example, a pointer returned by tb_malloc).
			   ...
			   int *ix, int *iy)
{
	...
	cleanup = tb_malloc (sizeof (*cleanup));
...
_cairo_image_analyze_transparency (cairo_image_surface_t      *image)
{
    ...
    if (image->format == CAIRO_FORMAT_RGB888
	|| image->format == CAIRO_FORMAT_RGB565
	|| image->format == CAIRO_FORMAT_ARGB1555)
    {
