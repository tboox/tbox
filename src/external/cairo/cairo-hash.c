...
_cairo_hash_table_create (cairo_hash_keys_equal_func_t keys_equal)
{
    ...
    hash_table = tb_malloc (sizeof (cairo_hash_table_t));
    ...
    hash_table->entries = tb_calloc (hash_table->arrangement->size,
...
_cairo_hash_table_resize (cairo_hash_table_t *hash_table)
{
    ...
    tmp.entries = tb_calloc (new_size, sizeof (cairo_hash_entry_t*));
