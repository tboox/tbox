			    ...
			    const cairo_pattern_t  *other)
{
    ...
    switch (other->type) {
    case CAIRO_PATTERN_TYPE_SOLID:
	pattern = tb_malloc (sizeof (cairo_solid_pattern_t));
	break;
    case CAIRO_PATTERN_TYPE_SURFACE:
	pattern = tb_malloc (sizeof (cairo_surface_pattern_t));
	break;
    case CAIRO_PATTERN_TYPE_LINEAR:
	pattern = tb_malloc (sizeof (cairo_linear_pattern_t));
	break;
    case CAIRO_PATTERN_TYPE_RADIAL:
	pattern = tb_malloc (sizeof (cairo_radial_pattern_t));
	break;
    default:
	ASSERT_NOT_REACHED;
