 ...
 * called to tb_free resources allocated during use of the array.
 **/
void
 ...
 * @additional tb_free spaces in the array. The actual size of the array
...
_cairo_array_grow_by (cairo_array_t *array, unsigned int additional)
{
	...
	array->elements = tb_malloc (sizeof (char *));
 ...
 * _cairo_user_data_array_fini() to tb_free any allocated memory
