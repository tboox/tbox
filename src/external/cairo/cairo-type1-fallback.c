                         ...
                         cairo_bool_t                 hex_encode)
{
    ...
    font = tb_calloc (1, sizeof (cairo_type1_font_t));
    if (unlikely (font == NULL))
	return _cairo_error (CAIRO_STATUS_NO_MEMORY);

    font->widths = tb_calloc (scaled_font_subset->num_glyphs, sizeof (int));
                                     ...
                                     cairo_bool_t                hex_encode)
{
    ...
    type1_subset->widths = tb_calloc (sizeof (int), font->scaled_font_subset->num_glyphs);
                               ...
                               cairo_scaled_font_subset_t *scaled_font_subset)
{
    ...
    type2_subset->widths = tb_calloc (sizeof (int), font->scaled_font_subset->num_glyphs);
